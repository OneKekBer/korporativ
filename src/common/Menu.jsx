...
const Menu = ({ toggleMenu, links, className }) => {
   return (
      <div
         onClick={toggleMenu}
      ...
      >
         <motion.div
            ...
            animate="animate"
            exit="exit"
            className={`${className || ''} fixed left-1/2 top-1/2 z-[400] flex h-[40%] w-[80%] -translate-x-1/2 -translate-y-1/2 transform items-center justify-center rounded-[5px] p-5 duration-300`}
         >
            <div
